...
namespace YouTubeGUI.Controls
{
    ...
    public static readonly StyledProperty<HorizontalAlignment> HorizontalContentAlignmentProperty =
        AvaloniaProperty.Register<AlignWrapPanel, HorizontalAlignment>(nameof(HorizontalContentAlignment));
    ...
    protected override Size MeasureOverride(Size constraint)
    {
        ...
        Avalonia.Controls.Controls children = base.Children;

        for (int i = 0; i < children.Count; i++)
        {
            IControl child = children[i] as IControl;
